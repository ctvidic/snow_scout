defmodule SnowScoutWeb.LiveHelpers do
  ...
  def live_modal(socket, component, opts) do
    ...
    live_component(socket, SnowScoutWeb.ModalComponent, modal_opts)
  end
  ...
  def assign_defaults(session, socket) do
    socket =
      assign_new(socket, :current_user, fn ->
        SnowScout.Accounts.get_user_by_session_token(session["user_token"])
      end)
